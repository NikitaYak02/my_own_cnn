...
static void run_custom_fprop(void)  { bmm_fprop(g_A, g_B, g_Y, g_N, g_W, g_H, g_C); }
static void run_custom_bprop(void)  { bmm_bprop(g_A, g_B, g_dY, g_dA, g_dB, g_N, g_W, g_H, g_C); }
...
int main(int argc, char** argv)
{
    ...
    /* bprop */
    bmm_bprop(dA, dB, dY_d, ddA, ddB, N, W, H, C);
